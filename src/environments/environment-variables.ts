...
const blocklyCdn =
  env['BLOCKLY_CDN'] ||
  `https://d1p6nuvm5rqwq0.cloudfront.net/blockly/v27/blockly.${locale === 'cs' ? 'cs' : 'en'}.min.js`;
...
const contactUrl = locale === 'cs' ? 'https://www.lumeer.io/cs/kontakt/' : 'https://www.lumeer.io/contact/';
