...
export class ViewComponent implements OnInit, OnDestroy {
  ...
  private askToCloneView(view: View) {
    ...
    const message = this.i18n({
      ...
      value: 'Do you want to create a copy of the view or just update existing?',
    });
    const cloneButtonText = this.i18n({id: 'view.dialog.clone.clone', value: 'Create a copy'});
    const renameButtonText = this.i18n({id: 'view.dialog.clone.update', value: 'Update existing'});
