...
// } from '../../data/convertor-old/chart-data-old';
// import {convertChartDateTickFormat} from '../chart-util';
// import {DraggablePlotMakerOld} from './draggable-plot-maker-old';
// import {createRange} from './plot-util';
//
// export abstract class AxisDraggablePlotMakerOld extends DraggablePlotMakerOld {
...
//       }
//
//       const tickFormat = convertChartDateTickFormat(dateConfig?.format);
//       return {
//         xaxis: {
//           type: 'date',
...
//       .sort();
//
//     const durationUnitsMap = this.chartData.constraintData?.durationUnitsMap;
