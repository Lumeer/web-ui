...
export const COLOR_BLUE = '#253746';
...
export const COLOR_LIGHT_ORANGE = '#fdd835';
export const COLOR_AMBER = '#ffd54f';
export const COLOR_YELLOW = '#f39c12';
export const COLOR_GREEN = '#00b388';
export const COLOR_TEAL = '#20c997';
export const COLOR_CYAN = '#3498db';

export const COLOR_PRIMARY = COLOR_BLUE;
export const COLOR_SECONDARY = COLOR_GRAY600;
