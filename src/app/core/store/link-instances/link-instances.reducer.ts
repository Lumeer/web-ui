...
export function linkInstancesReducer(state: LinkInstancesState = initialLinkInstancesState, action: LinkInstancesAction.All): LinkInstancesState {
  switch (action.type) {
    ...
    case LinkInstancesActionType.UPDATE_SUCCESS:
      return linkInstancesAdapter.updateOne({id: action.payload.linkInstance.id, changes: action.payload.linkInstance}, state);
